...
<head>
    ...
    <style>
        .page-content .grid>article>a {
            display: flex;
            font-size: larger;
            color: #36363e;
            border-radius: var(--border-radius);
            box-shadow: var(--box-shadow);
            text-shadow: 0px 2px 3px rgb(146, 138, 138);
...
<section class="page-content">
    <section class="search-and-user">
        <form>
            <input type="search" placeholder="查找社区...">
        ...
        <div class="admin-profile">
            <span class="greeting">你好 管理员！</span>
    ...
    <section class="grid">
        <article>
            <a href="/a" style="width:100% ; height: 100%;">
                <div style="width: 35%;">
                    <br><br>
                    <h2>碧桂园</h2><br><br>
                    <h4>--安居客社区信息</h4>
                </div>
                <img src="images/a.jpg" alt="" style="border-radius:20px; width: 65%;height: 100%;filter: drop-shadow(8px 5px 5px black);">
            </a>
        </article>
        <article>
            <a href="/b" style="width:100% ; height: 100%;">
                <div style="width: 35%;">
                    <br><br>
                    <h2>碧桂园</h2><br><br>
                    <h4>--天汇社区信息</h4>
                </div>
                <img src="images/b.jpg" alt="" style="border-radius:20px; width: 65%;height: 100%;filter: drop-shadow(8px 5px 5px black);">
            </a>
        </article>
        <article>
            <a href="/c" style="width:100% ; height: 100%;">
                <div style="width: 35%;">
                    <br><br>
                    <h2>碧桂园</h2><br><br>
                    <h4>--山外山（别墅）社区信息</h4>
                </div>
                <img src="images/c.jpg" alt="" style="border-radius:20px; width: 65%;height: 100%;filter: drop-shadow(8px 5px 5px black);">
            </a>
        </article>
        <article>
