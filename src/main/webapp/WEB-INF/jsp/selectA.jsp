...
<header class="page-header">
    <nav>
        ...
        <ul class="admin-menu">
            ...
            <li>
                <a href="/a/goods/list"target="text">
                    <svg>
            ...
            <li>
                <a href="/a/income/list"target="text">
                    <svg>
            ...
            <li>
                <a href="/a/output/list" target="text">
                    <svg>
...
<section class="page-content"style="padding: 0px">
    <div>
        <iframe src="/a/goods/list" name="text" style="width: 100%; height: 700px">
        </iframe>
    </div>
</section>
<!-- partial -->
